> Upstream OfficeCLI reference (`officecli-financial-model`), Apache-2.0, from github.com/iOfficeAI/OfficeCLI.
> Ignore its Install/Setup section — use the `officecli-setup` skill in this plugin instead.
